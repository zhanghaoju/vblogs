module.exports=[
    ...
    },
    {
        ...
        "icon": "",
        "items":[
            {text: '技术日常记录', link: '/document/daily-records/introduction/', icon: 'reco-document'},
            ...
            {text: '前端书籍阅读笔记', link: '/document/reading-notes/introduction/', icon: 'reco-document'},
            {text: '业务代码片段', link: '/document/business-code/introduction/', icon: 'reco-document'},
        ]
    },
    {
        "text": "星河滚烫",
        ...
        "items":[
            ...
            {text: '日常', link: '/happiness/life-records/introduction/', icon: 'reco-document'},
        ]
    },
    {
        "text": "索引",
